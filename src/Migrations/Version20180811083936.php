 ...
 */
final class Version20180811083936 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE planning (id INT AUTO_INCREMENT NOT NULL, day_id INT NOT NULL, employee_id INT NOT NULL, company_id INT NOT NULL, day_date DATE NOT NULL, start_time TIME NOT NULL, stop_time TIME NOT NULL, week SMALLINT NOT NULL, year DATE NOT NULL, INDEX IDX_D499BFF69C24126 (day_id), INDEX IDX_D499BFF68C03F15C (employee_id), INDEX IDX_D499BFF6979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE schedule (id INT AUTO_INCREMENT NOT NULL, day_id INT NOT NULL, company_id INT NOT NULL, first_time_start TIME DEFAULT NULL, first_time_stop TIME DEFAULT NULL, second_time_start TIME DEFAULT NULL, second_time_stop TIME DEFAULT NULL, INDEX IDX_5A3811FB9C24126 (day_id), INDEX IDX_5A3811FB979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
