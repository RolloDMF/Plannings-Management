 ...
 */
final class Version20181029121958 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE schedule (id INT AUTO_INCREMENT NOT NULL, day_id INT NOT NULL, company_id INT NOT NULL, first_time_start TIME DEFAULT NULL, first_time_stop TIME DEFAULT NULL, second_time_start TIME DEFAULT NULL, second_time_stop TIME DEFAULT NULL, converted_first_time_start NUMERIC(4, 2) DEFAULT NULL, converted_first_time_stop NUMERIC(4, 2) DEFAULT NULL, converted_second_time_start NUMERIC(4, 2) DEFAULT NULL, converted_second_time_stop NUMERIC(4, 2) DEFAULT NULL, morning_work_time NUMERIC(4, 2) DEFAULT NULL, afternoon_work_time NUMERIC(4, 2) DEFAULT NULL, meal_break NUMERIC(4, 2) DEFAULT NULL, INDEX IDX_5A3811FB9C24126 (day_id), INDEX IDX_5A3811FB979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
